<div class="card">
                ...
                <ul class="list-group list-group-flush">
                    @if(!empty($item->director))
                        <li class="list-group-item director">
                            <em class="fas fa-user mr-2"></em><strong class="mr-1">Director</strong>
                            <span class="text-info">{{$item->director}}</span>
                        </li>
                    @endif
                    @if(!empty($item->studio))
                        <li class="list-group-item studio">
                            <em class="fas fa-tag mr-2"></em><strong class="mr-1">Studio</strong>
                            <span class="text-info">{{$item->studio}}</span>
                        </li>
                    @endif
                    @if(!empty($item->label))
                        <li class="list-group-item label">
                            <em class="fas fa-tag mr-2"></em><strong class="mr-1">Label</strong>
    ...
    <div class="card-footer">
        <small class="text-muted"><em class="far fa-calendar-alt mr-1"></em>{{$item->release_date}}</small>
